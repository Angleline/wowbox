...
local function ClassTalentBuilders_func(self,arg1,arg2)
	...
	Lib_UIDropDownMenu_SetSelectedValue(BF_TalentSelectDropDown, self.value)
end
...
function BFTalent_Initialize()
	...
	local frame = CreateFrame("Frame", "BF_TalentSelectDropDown", PlayerTalentFrameTalents, "Lib_UIDropDownMenuTemplate");
	Lib_UIDropDownMenu_Initialize(frame, BF_TalentSelectDropDown_Init)
	frame:SetPoint("TOPLEFT", "PlayerTalentFrame", "TOPLEFT", 50, -30);
	frame:SetFrameLevel(PlayerTalentFrame:GetFrameLevel()+1)
	Lib_UIDropDownMenu_SetSelectedValue(BF_TalentSelectDropDown, BFTalent_Title)
