...
function RaidMark:CreateMarkFrame()
	...
	self.mover.menu = CreateFrame("Frame", "RaidMarkMainFrameMoverMenu", self.mover, "Lib_UIDropDownMenuTemplate");
	self.mover.menu:Hide();
	Lib_UIDropDownMenu_Initialize(self.mover.menu, dwRaidMarkInitMenu, "MENU");
