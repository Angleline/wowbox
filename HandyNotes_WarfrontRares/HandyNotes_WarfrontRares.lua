...
local iconDefaults = {
	...
	skullWhite = {
		icon = "Interface\\Addons\\HandyNotes_WarfrontRares\\Artwork\\skulls.blp",
...
function Arathi:OnInitialize()
    ...
    self.db = LibStub("AceDB-3.0"):New("HandyNotesWarfrontRaresDB", defaults, "Default");
...
function Arathi:RegisterWithHandyNotes()
    ...
    HandyNotes:RegisterPluginDB("HandyNotesWarfrontRares", self, options)
...
function Arathi:Refresh()
    self:SendMessage("HandyNotes_NotifyUpdate", "HandyNotesWarfrontRares")
end
