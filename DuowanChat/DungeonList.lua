...
function DungeonList:OnInitialize()
	self.lastZone = "";
	self.menuFrame = CreateFrame("Frame", "dwChatDungeonListMenuFrame", DWCDungeonListButton, "Lib_UIDropDownMenuTemplate");
	self.menuFrame:Hide();
...
local function DgSetItemRef(link, text, button)
...
--	self:RawHook("SetItemRef", true);
	hooksecurefunc("SetItemRef", DgSetItemRef);
