...
local defaults = {
	profile = {
		...
		barSettings = {
			['*'] = {
				barName = "主信息条", align = "center", enabled = true, index = 10, width = 600,
			},
			['主信息条'] = {
				barName = "主信息条", align = "center", enabled = true, index = 1, width = 600,
			},
		},
		objSettings = {
			['*'] = {
				barName = "主信息条", align = "center", enabled = true, showText = true,
				showIcon = true, index = 500, width = 600,
			},
			["RangeDisplay"] = {
				["enabled"] = false,
			},
...
function ChocolateBar:EnableDataObject(name, obj, noupdate)
	...
	if bar then
		...
		chocolateBars["主信息条"]:AddChocolatePiece(choco, name,noupdate)
	end
