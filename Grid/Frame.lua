...
Media:Register("statusbar", "Gloss", "Interface\\AddOns\\Grid\\Media\\Gloss")
...
GridFrame.defaultDB = {
	...
	showTooltip = "OOC",
	rightClickMenu = true,
	orientation = "HORIZONTAL", --eui.cc
	textorientation = "HORIZONTAL", --eui.cc
	...
	statusmap = {
		text = {
			...
			alert_offline = true,
			debuff_Ghost = true,
			unit_healthDeficit = false, --by eui.cc
			unit_name = true,
		},
		text2 = {
			alert_death = true,
