...
function AuctionLite:AuctionFrameTab_OnClick_Hook(tab, arg)
  ...
  elseif index == SellTabIndex then
    AuctionFrameTopLeft:SetTexture("Interface\\AddOns\\Fence\\Modules\\AuctionLite\\Images\\SellFrame-TopLeft");
	AuctionFrameTop:SetTexture("Interface\\AddOns\\Fence\\Modules\\AuctionLite\\Images\\SellFrame-Top");
	AuctionFrameTopRight:SetTexture("Interface\\AddOns\\Fence\\Modules\\AuctionLite\\Images\\SellFrame-TopRight");
	AuctionFrameBotLeft:SetTexture("Interface\\AddOns\\Fence\\Modules\\AuctionLite\\Images\\SellFrame-BotLeft");
	AuctionFrameBot:SetTexture("Interface\\AddOns\\Fence\\Modules\\AuctionLite\\Images\\SellFrame-Bot");
	AuctionFrameBotRight:SetTexture("Interface\\AddOns\\Fence\\Modules\\AuctionLite\\Images\\SellFrame-BotRight");
