...
function AuctionLite:InitConfig()
  ...
  registry:RegisterOptionsTable(L["AuctionLite Options"], Options);
  registry:RegisterOptionsTable(L["AuctionLite Buy"], BuyOptions);
  registry:RegisterOptionsTable(L["AuctionLite Sell"], SellOptions);
  --registry:RegisterOptionsTable(L["AuctionLite Tooltips"],, TooltipOptions);
  registry:RegisterOptionsTable(L["AuctionLite Favorites"], FavoritesOptions);
  registry:RegisterOptionsTable(L["AuctionLite Profiles"], profiles);

  local dialog = LibStub("AceConfigDialog-3.0");
  self.optionFrames = {
    main     = dialog:AddToBlizOptions(L["AuctionLite Options"], L["AuctionLite"]),
    buy      = dialog:AddToBlizOptions(L["AuctionLite Buy"], L["Buy Tab"],
                                       L["AuctionLite"]);
    sell     = dialog:AddToBlizOptions(L["AuctionLite Sell"], L["Sell Tab"],
                                       L["AuctionLite"]);
    --tooltips = dialog:AddToBlizOptions(L["AuctionLite Tooltips"], L["Tooltips"],
    --                                   L["AuctionLite"]);
    favs     = dialog:AddToBlizOptions(L["AuctionLite Favorites"], L["Favorites"],
                                       L["AuctionLite"]);
    profiles = dialog:AddToBlizOptions(L["AuctionLite Profiles"], L["Profiles"],
                                       L["AuctionLite"]);
  };
end
