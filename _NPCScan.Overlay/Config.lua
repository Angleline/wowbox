...
-- Key Font Dropdown
panel.KeyFont = _G.CreateFrame("Frame", "%parentFontDropdown", panel, "Lib_UIDropDownMenuTemplate")
panel.KeyFont:SetPoint("TOPLEFT", panel.KeySizeTitle, "BOTTOMLEFT", -10, -30)
Lib_UIDropDownMenu_SetWidth(panel.KeyFont, 200) 
panel.KeyFont:EnableMouse(true)

_G.Lib_UIDropDownMenu_JustifyText(panel.KeyFont, "LEFT")

panel.KeyFont.Button = _G[panel.KeyFont:GetName() .. "Button"]
_G.Lib_UIDropDownMenu_SetAnchor(panel.KeyFont, 0, 0, "TOPLEFT", panel.KeyFont.Button, "TOPRIGHT")
...
do
	local function Entry_OnSelect(info_table, font)
		...
		_G.Lib_UIDropDownMenu_SetText(panel.KeyFont, font == private.DEFAULT_FONT_NAME and "Default" or font)
