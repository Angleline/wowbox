...
--------------------
SPELL_TIMER_LEVEL_ROMAN = {" IX", " VIII", " VII", " VI", " V",  " IV", " III", " II", ""};
...
if (GetLocale() =="zhCN") then
	...
	SPELL_TIMER_MERGE_AOE = "将多个相同计时合并为AOE计时";
	...
	SPELL_TIMER_PATTERN_TABLE["WARLOCK"]["痛楚"] = {nil};--
	SPELL_TIMER_PATTERN_TABLE["WARLOCK"]["邪焰"] = {nil};--
	...
	--SPELL_TIMER_PATTERN_TABLE["WARLOCK"]["末日灾祸"] = {nil, nil, nil, {"痛苦灾祸", "浩劫灾祸"}};
	--SPELL_TIMER_PATTERN_TABLE["WARLOCK"]["厄运灾祸"] = {nil, nil, nil, {"痛苦灾祸", "灾祸灾祸"}};
	--SPELL_TIMER_PATTERN_TABLE["WARLOCK"]["痛苦灾祸"] = {nil, nil, nil, {"末日灾祸", "浩劫灾祸"}};
	--SPELL_TIMER_PATTERN_TABLE["WARLOCK"]["浩劫灾祸"] = {nil, nil, nil, {"末日灾祸", "痛苦灾祸"}};

	SPELL_TIMER_PATTERN_TABLE["WARLOCK"]["元素诅咒"] = {nil, nil, nil, {"痛苦诅咒", "语言诅咒", "疲劳诅咒"}};--
	SPELL_TIMER_PATTERN_TABLE["WARLOCK"]["虚弱诅咒"] = {nil, nil, nil, {"元素诅咒", "厄运诅咒", "疲劳诅咒"}};--
	SPELL_TIMER_PATTERN_TABLE["WARLOCK"]["语言诅咒"] = {nil, nil, nil, {"元素诅咒", "虚弱诅咒", "疲劳诅咒"}};
	SPELL_TIMER_PATTERN_TABLE["WARLOCK"]["疲劳诅咒"] = {nil, nil, nil, {"痛苦诅咒", "虚弱诅咒", "元素诅咒"}};--
	...
	SPELL_TIMER_PATTERN_TABLE["WARLOCK"]["暗影烈焰"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["WARLOCK"]["鬼影缠身"] = {nil}; --
	--SPELL_TIMER_PATTERN_TABLE["WARLOCK"]["恶魔变形"] = {"buff", nil, nil, nil, {["live"] = 1}}; 
	SPELL_TIMER_PATTERN_TABLE["WARLOCK"]["不灭决心"] = {"buff", nil, nil, nil, {["live"] = 1}}; --
	SPELL_TIMER_PATTERN_TABLE["WARLOCK"]["暮光结界"] = {"buff", nil, nil, nil, {["live"] = 1}}; --
	SPELL_TIMER_PATTERN_TABLE["WARLOCK"]["黑暗灵魂：哀难"] = {"buff", nil, nil, nil, {["live"] = 1}}; --
	SPELL_TIMER_PATTERN_TABLE["WARLOCK"]["恶魔重生"] = {"buff", nil, nil, nil, {["live"] = 1, ["spell"] = {"恶魔重生CD", 120}}}; 
	SPELL_TIMER_PATTERN_TABLE["WARLOCK"]["挑战嚎叫"] = {"持续([%d%.]+)", nil, nil, nil, {["live"] = 1,["notarget"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["WARLOCK"]["暗影之怒"] = {nil};	
	SPELL_TIMER_PATTERN_TABLE["WARLOCK"]["古尔丹之手"] = {nil};--
	SPELL_TIMER_PATTERN_TABLE["WARLOCK"]["厄兆光环"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["WARLOCK"]["法术封锁"] = {nil};

	SPELL_TIMER_PATTERN_TABLE["ROGUE"] = {};	
	SPELL_TIMER_PATTERN_TABLE["ROGUE"]["凿击"] = {nil};--
	SPELL_TIMER_PATTERN_TABLE["ROGUE"]["仇杀"] = {nil};--
	...
	SPELL_TIMER_PATTERN_TABLE["ROGUE"]["扰乱"] = {nil, nil, nil, nil, {["live"] = 1,["notarget"] = 1}};--
	SPELL_TIMER_PATTERN_TABLE["ROGUE"]["还击"] = {nil};--
	SPELL_TIMER_PATTERN_TABLE["ROGUE"]["肾击"] = {nil};--
	SPELL_TIMER_PATTERN_TABLE["ROGUE"]["血之饥渴"] = {"buff", nil, nil, nil, {["live"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["ROGUE"]["暗遁"] = {"buff", nil, nil, nil, {["live"] = 1}};--
	SPELL_TIMER_PATTERN_TABLE["ROGUE"]["暗影斗篷"] = {"buff", nil, nil, nil, {["live"] = 1}};--
	SPELL_TIMER_PATTERN_TABLE["ROGUE"]["嫁祸诀窍"] = {"buff", nil, nil, nil, {["live"] = 1}};--
	SPELL_TIMER_PATTERN_TABLE["ROGUE"]["暗影之舞"] = {"buff", nil, nil, nil, {["live"] = 1}};--
	SPELL_TIMER_PATTERN_TABLE["ROGUE"]["毒伤"] = {"buff", nil, nil, nil, {["live"] = 1}};--
	SPELL_TIMER_PATTERN_TABLE["ROGUE"]["恢复"] = {"buff", nil, nil, nil, {["live"] = 1}};--
	SPELL_TIMER_PATTERN_TABLE["ROGUE"]["闪避"] = {"buff", nil, nil, nil, {["live"] = 1, ["notarget"] = 1}};--
	SPELL_TIMER_PATTERN_TABLE["ROGUE"]["消失"] = {"buff", nil, nil, nil, {["live"] = 1, ["notarget"] = 1}};--
	SPELL_TIMER_PATTERN_TABLE["ROGUE"]["出血"] = {nil};--
	SPELL_TIMER_PATTERN_TABLE["ROGUE"]["致命投掷"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["ROGUE"]["拆卸"] = {nil};--
	SPELL_TIMER_PATTERN_TABLE["ROGUE"]["打劫"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["ROGUE"]["铁棍"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["ROGUE"]["烟雾弹"] = {"持续([%d%.]+)", nil, nil, nil, {["live"] = 1,["notarget"] = 1}};--
	-- 毒药
	--for i, lv in ipairs(SPELL_TIMER_LEVEL_ROMAN) do
	SPELL_TIMER_PATTERN_TABLE["ROGUE"]["麻醉药膏"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["ROGUE"]["速效药膏"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["ROGUE"]["致伤药膏"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["ROGUE"]["致命药膏"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["ROGUE"]["麻痹药膏"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["ROGUE"]["减速药膏"] = {nil};
	--end
	
	SPELL_TIMER_PATTERN_TABLE["PRIEST"] = {};
	SPELL_TIMER_PATTERN_TABLE["PRIEST"]["暗言术：痛"] = {nil};--
	SPELL_TIMER_PATTERN_TABLE["PRIEST"]["沉默"] = {nil};--
	SPELL_TIMER_PATTERN_TABLE["PRIEST"]["麻痹"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["PRIEST"]["心灵尖啸"] = {"持续([%d%.]+)秒", nil, nil, nil, {["notarget"] = 1}};--
	--SPELL_TIMER_PATTERN_TABLE["PRIEST"]["吸血鬼的拥抱"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["PRIEST"]["恢复"] = {"both", nil, nil, nil, {["live"] = 1}};--
	SPELL_TIMER_PATTERN_TABLE["PRIEST"]["驱除疾病"] = {"both", nil, nil, nil, {["live"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["PRIEST"]["心灵惊骇"] = {nil};--
	SPELL_TIMER_PATTERN_TABLE["PRIEST"]["束缚亡灵"] = {nil, nil, nil, nil, {["unique"] = 1}};--
	SPELL_TIMER_PATTERN_TABLE["PRIEST"]["妙手回春"] = {nil, nil, nil, nil, {["unique"] = 1}};--
	SPELL_TIMER_PATTERN_TABLE["PRIEST"]["噬灵疫病"] = {nil, nil, nil, nil, {["unique"] = 1}};--
	...
	SPELL_TIMER_PATTERN_TABLE["PRIEST"]["守护之魂"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["PRIEST"]["暗影恶魔"] = {"持续([%d%.]+)秒", nil, nil, nil, {["live"] = 1,["notarget"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["PRIEST"]["真言术：障"] = {"持续([%d%.]+)秒", nil, nil, nil, {["live"] = 1,["notarget"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["PRIEST"]["渐隐术"] = {"buff", nil, nil, nil, {["live"] =1}};--
	SPELL_TIMER_PATTERN_TABLE["PRIEST"]["真言术：盾"] = {"both", nil, nil, nil, {["live"] =1}};--
	SPELL_TIMER_PATTERN_TABLE["PRIEST"]["灵魂护壳"] = {"both", nil, nil, nil, {["live"] =1}};--
	SPELL_TIMER_PATTERN_TABLE["PRIEST"]["圣言术：静"] = {"buff", nil, nil, nil, {["live"] =1}};

	SPELL_TIMER_PATTERN_TABLE["WARRIOR"] = {};
	SPELL_TIMER_PATTERN_TABLE["WARRIOR"]["断筋"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["WARRIOR"]["强化断筋"] = {nil, nil, nil, nil, {["spell"] = {"强化断筋 CD", 60}}};
	SPELL_TIMER_PATTERN_TABLE["WARRIOR"]["撕裂"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["WARRIOR"]["盾击"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["WARRIOR"]["挫志怒吼"] = {"持续([%d%.]+)秒", nil, nil, nil, {["notarget"] =1}};
	SPELL_TIMER_PATTERN_TABLE["WARRIOR"]["刺耳怒吼"] = {"眩晕([%d%.]+)秒", nil, nil, nil, {["notarget"] =1}};
	SPELL_TIMER_PATTERN_TABLE["WARRIOR"]["惩戒痛击"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["WARRIOR"]["雷霆一击"] = {"持续([%d%.]+)秒", nil, nil, nil, {["notarget"] =1}};
	SPELL_TIMER_PATTERN_TABLE["WARRIOR"]["缴械"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["WARRIOR"]["巨人打击"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["WARRIOR"]["破胆怒吼"] = {"持续([%d%.]+)秒", nil, nil, nil, {["notarget"] =1}};
	SPELL_TIMER_PATTERN_TABLE["WARRIOR"]["破甲攻击"] = {"持续([%d%.]+)秒"};
	SPELL_TIMER_PATTERN_TABLE["WARRIOR"]["致死打击"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["WARRIOR"]["碎裂投掷"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["WARRIOR"]["拦截"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["WARRIOR"]["击倒"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["WARRIOR"]["暴怒"] = {"持续([%d%.]+)秒", nil, nil, nil, {["notarget"] = 1, ["live"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["WARRIOR"]["法术反射"] = {"buff"};
	SPELL_TIMER_PATTERN_TABLE["WARRIOR"]["缴械"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["WARRIOR"]["震荡猛击"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["WARRIOR"]["震荡波"] = {nil};
	...
	SPELL_TIMER_PATTERN_TABLE["HUNTER"]["黑箭"] = {nil}; 
	SPELL_TIMER_PATTERN_TABLE["HUNTER"]["瞄准射击"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["HUNTER"]["沉默射击"] = {nil}; 
	SPELL_TIMER_PATTERN_TABLE["HUNTER"]["扰乱射击"] = {nil};
	...
	SPELL_TIMER_PATTERN_TABLE["HUNTER"]["急速射击"] = {"buff", nil, nil, nil, {["live"] = 1}};
	...
	SPELL_TIMER_PATTERN_TABLE["DRUID"]["野蛮咆哮"] = {"buff", nil, nil, nil, {["live"] = 1}};
	...
	SPELL_TIMER_PATTERN_TABLE["DRUID"]["愈合"] = {"both", nil, nil, nil, {["live"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["DRUID"]["回春术"] = {"both", nil, nil, nil, {["live"] = 1}};
	...
	SPELL_TIMER_PATTERN_TABLE["DRUID"]["裂伤"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["DRUID"]["日光术"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["DRUID"]["阳炎术"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["DRUID"]["激活"] = {"both", nil, nil, nil, {["live"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["DRUID"]["野性成长"] = {nil, nil, nil, nil, {["live"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["DRUID"]["割伤"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["DRUID"]["生命绽放"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["ROGUE"]["割碎"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["DRUID"]["飓风术"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["DRUID"]["月蚀"] = {"buff", nil, nil, nil, {["live"] = 1, ["nocheck"]=1, ["spell"] = {"月蚀 CD", 30}}};
	SPELL_TIMER_PATTERN_TABLE["DRUID"]["日蚀"] = {"buff", nil, nil, nil, {["live"] = 1, ["nocheck"]=1, ["spell"] = {"日蚀 CD", 30}}};
	...
	SPELL_TIMER_PATTERN_TABLE["SHAMAN"]["激流"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["SHAMAN"]["元素掌握"] = {"buff", nil, nil, nil, {["live"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["SHAMAN"]["激流"] = {"buff", nil, nil, nil, {["live"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["SHAMAN"]["萨满之怒"] = {"buff", nil, nil, nil, {["live"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["SHAMAN"]["潮汐之力"] = {"buff", nil, nil, nil, {["live"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["SHAMAN"]["束缚元素"] = {"buff", nil, nil, nil, {["unique"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["SHAMAN"]["烈焰震击"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["SHAMAN"]["冰霜震击"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["SHAMAN"]["大地震击"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["SHAMAN"]["妖术"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["SHAMAN"]["野性狼魂"] = {"持续([%d%.]+)", nil, nil, nil, {["live"] = 1,["notarget"] = 1}}; 
	SPELL_TIMER_PATTERN_TABLE["SHAMAN"]["嗜血"] = {"持续([%d%.]+)",  nil, nil, nil, {["live"] = 1,["notarget"] = 1}}; 
	SPELL_TIMER_PATTERN_TABLE["SHAMAN"]["英勇"] = {"持续([%d%.]+)",  nil, nil, nil, {["live"] = 1,["notarget"] = 1}}; 
	SPELL_TIMER_PATTERN_TABLE["SHAMAN"]["自然的守护者"] = {"buff",  nil, nil, nil, {["live"] = 1, ["spell"] = {"自然的守护者 CD", 30}}};

	SPELL_TIMER_PATTERN_TABLE["PALADIN"] = {};
	SPELL_TIMER_PATTERN_TABLE["PALADIN"]["制裁之锤"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["PALADIN"]["忏悔"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["PALADIN"]["超度邪恶"] = {nil};  
	SPELL_TIMER_PATTERN_TABLE["PALADIN"]["神启"] = {"持续([%d%.]+)秒", nil, nil, nil, {["notarget"] = 1, ["live"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["PALADIN"]["圣光之赐"] = {"buff", nil, nil, nil, {["live"] = 1}};	
	SPELL_TIMER_PATTERN_TABLE["PALADIN"]["正义复仇"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["PALADIN"]["血之腐蚀"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["PALADIN"]["神圣愤怒"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["PALADIN"]["复仇者之盾"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["PALADIN"]["辩护"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["PALADIN"]["神圣恳求"] = {"buff", nil, nil, nil, {["live"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["PALADIN"]["圣洁护盾"] = {"both", nil, nil, nil, {["live"] = 1}};	
	SPELL_TIMER_PATTERN_TABLE["PALADIN"]["牺牲之手"] = {nil, nil, nil, {"拯救之手", "自由之手", "保护之手"}, {["live"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["PALADIN"]["拯救之手"] = {"both", nil, nil, {"牺牲之手", "自由之手", "保护之手"}, {["live"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["PALADIN"]["自由之手"] = {"both", nil, nil, {"牺牲之手", "拯救之手", "保护之手"}, {["live"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["PALADIN"]["保护之手"] = {"both", nil, nil, {"牺牲之手", "拯救之手", "自由之手"}, {["live"] = 1}};
	--SPELL_TIMER_PATTERN_TABLE["PALADIN"]["清算之手"] = {nil, nil, nil, {"牺牲之手", "拯救之手", "自由之手", "保护之手"}, {["live"] = 1}};
	...
	SPELL_TIMER_PATTERN_TABLE["MAGE"]["点燃"] = {nil};--
	SPELL_TIMER_PATTERN_TABLE["MAGE"]["冰霜之颌"] = {nil};  --
	SPELL_TIMER_PATTERN_TABLE["MAGE"]["深度冻结"] = {nil};  --
	SPELL_TIMER_PATTERN_TABLE["MAGE"]["霜寒刺骨"] = {nil}; 
	SPELL_TIMER_PATTERN_TABLE["MAGE"]["寒冰炸弹"] = {nil}; 
	SPELL_TIMER_PATTERN_TABLE["MAGE"]["寒冰屏障"] = {"buff", nil, nil, nil, {["live"] = 1}}; 
	SPELL_TIMER_PATTERN_TABLE["MAGE"]["时光护盾"] = {"buff", nil, nil, nil, {["live"] = 1}};  
	SPELL_TIMER_PATTERN_TABLE["MAGE"]["火焰易伤"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["MAGE"]["冰冷血脉"] = {"buff", nil, nil, nil, {["live"] = 1}};
	...
	SPELL_TIMER_PATTERN_TABLE["MAGE"]["寒冰宝珠"] = {"持续([%d%.]+)秒", nil, nil, nil, {["notarget"] =1}};
	SPELL_TIMER_PATTERN_TABLE["MAGE"]["召唤水元素"] = {"持续([%d%.]+)秒", nil, nil, nil, {["notarget"] =1, ["live"] = 1}}; 
	SPELL_TIMER_PATTERN_TABLE["MAGE"]["霜火之箭"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["MAGE"]["沉默 - 强化法术反制"] = {nil};--
	SPELL_TIMER_PATTERN_TABLE["MAGE"]["减速"] = {nil}; --
	SPELL_TIMER_PATTERN_TABLE["MAGE"]["活动炸弹"] = {nil}; --
	SPELL_TIMER_PATTERN_TABLE["MAGE"]["寒冰炸弹"] = {nil}; --
	SPELL_TIMER_PATTERN_TABLE["MAGE"]["强化灼烧"] = {nil}; --
	SPELL_TIMER_PATTERN_TABLE["MAGE"]["燃烧冲击"] = {nil}; -- 11095p	
	SPELL_TIMER_PATTERN_TABLE["MAGE"]["镜像"] = {"持续([%d%.]+)", nil, nil, nil, {["live"] = 1,["notarget"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["MAGE"]["龙息术"] = {"持续([%d%.]+)秒", nil, nil, nil, {["notarget"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["MAGE"]["寒冰结界"] = {"buff", nil, nil, nil, {["live"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["MAGE"]["隐形术"] = {"buff", nil, nil, nil, {["live"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["MAGE"]["强化隐形术"] = {"buff", nil, nil, nil, {["live"] = 1}};--
	SPELL_TIMER_PATTERN_TABLE["MAGE"]["咒术护盾"] = {"buff", nil, nil, nil, {["live"] = 1}};--

	SPELL_TIMER_PATTERN_TABLE["DEATHKNIGHT"] = {};
	SPELL_TIMER_PATTERN_TABLE["DEATHKNIGHT"]["冰霜疫病"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["DEATHKNIGHT"]["血之疫病"] = {nil}; 
	SPELL_TIMER_PATTERN_TABLE["DEATHKNIGHT"]["血红热疫"] = {nil}; 
	SPELL_TIMER_PATTERN_TABLE["DEATHKNIGHT"]["黑色热疫"] = {nil}; 
	SPELL_TIMER_PATTERN_TABLE["DEATHKNIGHT"]["绞袭"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["DEATHKNIGHT"]["冰冷触摸"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["DEATHKNIGHT"]["鲜血印记"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["DEATHKNIGHT"]["死疽打击"] = {nil};
	...
	SPELL_TIMER_PATTERN_TABLE["DEATHKNIGHT"]["黑锋冰寒"] = {"buff", nil, nil, nil, {["live"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["DEATHKNIGHT"]["铜墙铁壁"] = {"buff", nil, nil, nil, {["live"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["DEATHKNIGHT"]["白骨之盾"] = {"buff", nil, nil, nil, {["live"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["DEATHKNIGHT"]["寒冰锁链"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["DEATHKNIGHT"]["黑暗模拟"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["DEATHKNIGHT"]["邪恶虫群"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["DEATHKNIGHT"]["饥饿之寒"] = {"持续([%d%.]+)",  nil, nil, nil, {["live"] = 1,["notarget"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["DEATHKNIGHT"]["反魔法护罩"] = {"buff",  nil, nil, nil, {["live"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["DEATHKNIGHT"]["召唤石像鬼"] = {"持续([%d%.]+)", nil, nil, nil, {["live"] = 1,["notarget"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["DEATHKNIGHT"]["反魔法领域"] = {"持续([%d%.]+)", nil, nil, nil, {["live"] = 1,["notarget"] = 1}};
...
elseif (GetLocale() == "zhTW") then
	...
	SPELL_TIMER_PATTERN_TABLE["WARLOCK"]["元素詛咒"] = {nil, nil, nil, {"虛弱詛咒", "語言詛咒", "疲勞詛咒"}};
	SPELL_TIMER_PATTERN_TABLE["WARLOCK"]["虛弱詛咒"] = {nil, nil, nil, {"元素詛咒", "語言詛咒", "疲勞詛咒"}};
	SPELL_TIMER_PATTERN_TABLE["WARLOCK"]["語言詛咒"] = {nil, nil, nil, {"元素詛咒", "虛弱詛咒", "疲勞詛咒"}};
	...
	SPELL_TIMER_PATTERN_TABLE["WARLOCK"]["疲勞詛咒"] = {nil, nil, nil, {"元素詛咒", "虛弱詛咒", "語言詛咒"}};
	SPELL_TIMER_PATTERN_TABLE["WARLOCK"]["末日災厄"] = {nil, nil, nil, {"痛苦災厄", "浩劫災厄"}};
	SPELL_TIMER_PATTERN_TABLE["WARLOCK"]["痛苦災厄"] = {nil, nil, nil, {"末日災厄", "浩劫災厄"}};
	SPELL_TIMER_PATTERN_TABLE["WARLOCK"]["浩劫災厄"] = {nil, nil, nil, {"末日災厄", "痛苦災厄"}};
	...
	SPELL_TIMER_PATTERN_TABLE["WARLOCK"]["誘惑"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["WARLOCK"]["鬼影缠身"] = {nil};	
	SPELL_TIMER_PATTERN_TABLE["WARLOCK"]["獻祭光環"] = {"buff"};	
	SPELL_TIMER_PATTERN_TABLE["WARLOCK"]["召喚末日守衛"] = {"持續([%d%.]+)秒", nil, nil, nil, {["notarget"] =1, ["live"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["WARLOCK"]["召喚煉獄火"] = {"持續([%d%.]+)秒", nil, nil, nil, {["notarget"] =1, ["live"] = 1}};
	...
	SPELL_TIMER_PATTERN_TABLE["ROGUE"]["毒化"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["ROGUE"]["仇殺"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["ROGUE"]["鮮血渴求"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["ROGUE"]["暗影之舞"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["ROGUE"]["暗影披風"] = {"buff", nil, nil, nil, {["live"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["ROGUE"]["疾跑"] = {"buff", nil, nil, nil, {["live"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["ROGUE"]["閃避"] = {"buff", nil, nil, nil, {["live"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["ROGUE"]["卸除武裝"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["ROGUE"]["煙霧彈"] = {"持續([%d%.]+)秒", nil, nil, nil, {["notarget"] =1, ["live"] = 1}};
	
	-- 毒药
	--for i, lv in ipairs(SPELL_TIMER_LEVEL_ROMAN) do
	SPELL_TIMER_PATTERN_TABLE["ROGUE"]["麻醉毒藥"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["ROGUE"]["速效毒藥"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["ROGUE"]["致傷毒藥"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["ROGUE"]["致命毒藥"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["ROGUE"]["麻痹毒藥"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["ROGUE"]["致殘毒藥"] = {nil};
	--end
	...
	SPELL_TIMER_PATTERN_TABLE["PRIEST"]["恢復"] = {"both", nil, nil, nil, {["live"] = 1}};
	...
	SPELL_TIMER_PATTERN_TABLE["PRIEST"]["聖言術:寧"] = {"both", nil, nil, nil, {["live"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["PRIEST"]["暗影惡魔"] = {"持續([%d%.]+)秒", nil, nil, nil, {["notarget"] = 1, ["live"] = 1}};
	
	SPELL_TIMER_PATTERN_TABLE["WARRIOR"] = {} 
	SPELL_TIMER_PATTERN_TABLE["WARRIOR"]["斷筋"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["WARRIOR"]["撕裂"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["WARRIOR"]["盾擊"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["WARRIOR"]["挫志怒吼"] = {"buff", nil, nil, nil, {["live"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["WARRIOR"]["破膽怒吼"] = {"buff", nil, nil, nil, {["live"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["WARRIOR"]["挑戰怒吼"] = {"buff", nil, nil, nil, {["live"] = 1}};
	...
	SPELL_TIMER_PATTERN_TABLE["WARRIOR"]["破甲攻擊"] = {nil} 
	SPELL_TIMER_PATTERN_TABLE["WARRIOR"]["致死打擊"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["WARRIOR"]["攔截"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["WARRIOR"]["狂暴之怒"] = {"持續([%d%.]+)", nil, nil, nil, {["notarget"] = 1, ["live"] = 1}}; -- 29801
	SPELL_TIMER_PATTERN_TABLE["WARRIOR"]["巨像碎擊"] = {nil}; 
	SPELL_TIMER_PATTERN_TABLE["WARRIOR"]["法術反射"] = {"buff", nil, nil, nil, {["live"] = 1}}; 
	SPELL_TIMER_PATTERN_TABLE["WARRIOR"]["魯莽"] = {"buff", nil, nil, nil, {["live"] = 1}}; 	
	SPELL_TIMER_PATTERN_TABLE["WARRIOR"]["盾牆"] = {"buff", nil, nil, nil, {["live"] = 1}};
	...
	SPELL_TIMER_PATTERN_TABLE["HUNTER"]["擾亂射擊"] = {nil} 
	...
	SPELL_TIMER_PATTERN_TABLE["HUNTER"]["爆炸陷阱效果"] = {nil, nil, nil, {"爆炸陷阱"}, {["any"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["HUNTER"]["毒蛇陷阱效果"] = {nil, nil, nil, {"毒蛇陷阱"}, {["any"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["HUNTER"]["急速射擊"] = {"buff", nil, nil, nil, {["live"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["HUNTER"]["寡婦毒液"] = {nil} 

	SPELL_TIMER_PATTERN_TABLE["DRUID"] = {} 
	SPELL_TIMER_PATTERN_TABLE["DRUID"]["休眠"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["DRUID"]["月火術"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["DRUID"]["重擊"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["DRUID"]["挫志咆哮"] = {"buff", nil, nil, nil, {["live"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["DRUID"]["挑戰咆哮"] = {"buff", nil, nil, nil, {["live"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["DRUID"]["兇蠻咆哮"] = {"buff", nil, nil, nil, {["live"] = 1}};
	...
	SPELL_TIMER_PATTERN_TABLE["DRUID"]["癒合"] = {"both", nil, nil, nil, {["live"] = 1}} 
	SPELL_TIMER_PATTERN_TABLE["DRUID"]["回春術"] = {"both", nil, nil, nil, {["live"] = 1}};
	...
	SPELL_TIMER_PATTERN_TABLE["DRUID"]["割裂"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["DRUID"]["生命之花"] = {nil, nil, nil, nil, {["live"] = 1, ["unique"] = 1}};
	...
	SPELL_TIMER_PATTERN_TABLE["SHAMAN"]["冰霜震擊"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["SHAMAN"]["烈焰震擊"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["SHAMAN"]["大地震擊"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["SHAMAN"]["氣漩武器"] = {nil, nil, nil, nil, {["live"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["SHAMAN"]["靈行者之賜"] = {"buff", nil, nil, nil, {["live"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["SHAMAN"]["元素束縛"] = {nil, nil, nil, nil, {["unique"] = 1}};

	SPELL_TIMER_PATTERN_TABLE["PALADIN"] = {} 
	SPELL_TIMER_PATTERN_TABLE["PALADIN"]["制裁之錘"] = {nil} 
	SPELL_TIMER_PATTERN_TABLE["PALADIN"]["懺悔"] = {nil} 
	--SPELL_TIMER_PATTERN_TABLE["PALADIN"]["超度不死生物"] = {nil}
	SPELL_TIMER_PATTERN_TABLE["PALADIN"]["神聖啟發"] = {"持續([%d%.]+)", nil, nil, nil, {["notarget"] = 1, ["live"] = 1}}; 
	SPELL_TIMER_PATTERN_TABLE["PALADIN"]["光明賜福"] = {"buff", nil, nil, nil, {["live"] = 1}}; 
	SPELL_TIMER_PATTERN_TABLE["PALADIN"]["聖光信標"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["PALADIN"]["公正復仇"] = {nil}; 
	SPELL_TIMER_PATTERN_TABLE["PALADIN"]["崇聖護盾"] = {"both"}; 
	SPELL_TIMER_PATTERN_TABLE["PALADIN"]["退邪術"] = {nil, nil, nil, nil, {["unique"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["PALADIN"]["神性祈求"] = {"buff", nil, nil, nil, {["live"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["PALADIN"]["犧牲聖禦"] = {nil, nil, nil, {"拯救聖禦", "自由聖禦", "保護聖禦"}, {["live"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["PALADIN"]["拯救聖禦"] = {"both", nil, nil, {"犧牲聖禦", "自由聖禦", "保護聖禦"}, {["live"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["PALADIN"]["自由聖禦"] = {"both", nil, nil, {"犧牲聖禦", "拯救聖禦", "保護聖禦"}, {["live"] = 1}};
	SPELL_TIMER_PATTERN_TABLE["PALADIN"]["保護聖禦"] = {"both", nil, nil, {"犧牲聖禦", "拯救聖禦", "自由聖禦"}, {["live"] = 1}};

	SPELL_TIMER_PATTERN_TABLE["MAGE"] = {} 
	SPELL_TIMER_PATTERN_TABLE["MAGE"]["變形術"] = {"持續([%d%.]+)秒", nil,nil,{"變豬術","變龜術"},{["live"] = 1, ["unique"] = 1}} 
	SPELL_TIMER_PATTERN_TABLE["MAGE"]["變豬術"] = {"持續([%d%.]+)秒",nil,nil,{"變形術","變龜術"},{["live"] = 1, ["unique"] = 1}}
	SPELL_TIMER_PATTERN_TABLE["MAGE"]["變龜術"] = {"持續([%d%.]+)秒",nil,nil,{"變形術","變豬術"},{["live"] = 1, ["unique"] = 1}}
	...
	SPELL_TIMER_PATTERN_TABLE["MAGE"]["活體爆彈"] = {nil}; -- 44457
	SPELL_TIMER_PATTERN_TABLE["MAGE"]["強化灼燒"] = {nil}; 
	SPELL_TIMER_PATTERN_TABLE["MAGE"]["幻鏡之像"] = {"持續([%d%.]+)秒", nil, nil, nil, {["live"] = 1}};
	--SPELL_TIMER_PATTERN_TABLE["MAGE"]["隱形術"] = {"buff", nil, nil, nil, {["live"] = 1}};	
	SPELL_TIMER_PATTERN_TABLE["MAGE"]["霜火箭"] = {nil}; 	
	...
	SPELL_TIMER_PATTERN_TABLE["DEATHKNIGHT"]["亡域打擊"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["DEATHKNIGHT"]["絞殺"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["DEATHKNIGHT"]["心智冰封"] = {nil};
	SPELL_TIMER_PATTERN_TABLE["DEATHKNIGHT"]["冰錮堅韌"] = {"buff", nil, nil, nil, {["live"] = 1}};
	...
	SPELL_TIMER_MERGE_AOE = "Merge more spell timer as aoe";
