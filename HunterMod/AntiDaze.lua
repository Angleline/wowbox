...
function AntiDaze:OnCombatEvent()
--	local timestamp, event, _, sourceGUID, sourceName, sourceFlags, destGUID, destName, destFlags, _, _, spellName, spellSchool, auraType, amount = CombatLogGetCurrentEventInfo();
	local timestamp, event, _, sourceGUID, sourceName, sourceFlags, sourceRaidFlags, destGUID, destName, destFlags, destRaidFlags, extraArg1, spellName, auraType, extraArg4, extraArg5, extraArg6, extraArg7, extraArg8, extraArg9, extraArg10 = CombatLogGetCurrentEventInfo()
