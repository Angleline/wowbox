...
EA_SPELL_POWER_MANA = Enum.PowerType.Mana
EA_SPELL_POWER_RAGE = Enum.PowerType.Rage
EA_SPELL_POWER_FOCUS = Enum.PowerType.Focus
EA_SPELL_POWER_ENERGY = Enum.PowerType.Energy
EA_SPELL_POWER_RUNES = Enum.PowerType.Runes
EA_SPELL_POWER_RUNIC_POWER = Enum.PowerType.RunicPower
EA_SPELL_POWER_SOUL_SHARDS = Enum.PowerType.SoulShards
EA_SPELL_POWER_LUNAR_POWER = Enum.PowerType.LunarPower
EA_SPELL_POWER_HOLY_POWER = Enum.PowerType.HolyPower
EA_SPELL_POWER_LIGHT_FORCE = Enum.PowerType.Chi
EA_SPELL_POWER_INSANITY = Enum.PowerType.Insanity
EA_SPELL_POWER_BURNING_EMBERS = Enum.PowerType.Obsolete
EA_SPELL_POWER_DEMONIC_FURY = Enum.PowerType.Fury
EA_SPELL_POWER_ARCANE_CHARGES = Enum.PowerType.ArcaneCharges
EA_SPELL_POWER_MAELSTROM = Enum.PowerType.Maelstrom
EA_SPELL_POWER_FURY = Enum.PowerType.Fury
EA_SPELL_POWER_PAIN = Enum.PowerType.Pain
