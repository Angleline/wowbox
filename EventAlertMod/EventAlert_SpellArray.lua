...
--------------------------------------------------------------------------------
	EADef_Items[EA_CLASS_DK] = {
		...
		["ITEMS"] = {
			...
			[49222] = {enable=true,},   -- 纄癌ぇ
			[52424] = {enable=true,},   -- は阑忌
			[53386] = {enable=true,},   -- Cinderglacier (Runeforge) /  聈
		},
		-- Alternate Alert / 本職業額外提醒區
		["ALTITEMS"] = {
			[56815] = {enable=true,},   -- Rune Strike / 才ゅゴ阑
		},
		-- Target Alert / 目標提醒區
		["TARITEMS"] = {
			...
			[81130] = {enable=true, self=true,},    -- ﹀︹荐
			[81326] = {enable=true, self=false},	-- 瞶端
			[115798] = {enable=true, self=false,},	-- 畓てю阑
			[117737] = {enable=true, self=false,},	-- 碰╣ (臸4)
			[117756] = {enable=true, self=false,},	-- ┠蓝 (臸4)
			[123059] = {enable=true, self=false,},	-- 笆穘 (倪5糤端buff)
			[123471] = {enable=true, self=false},	-- 糤眏 (倪ぇみ2)
			[126958] = {enable=true, self=false,},	-- ┰焚ぇ牟 (臸┣)
			[127372] = {enable=true, self=false,},	-- ぃ铆﹚﹀睲
			[131996] = {enable=true, self=false,},	-- 礹阑 (伦瑄4┷)			
			[132726] = {enable=true, self=false,},	-- Θ
			[136431] = {enable=true, self=false,},				
			},
		...
		["SCDITEMS"] = {
			...
			[47568] = {enable=false,},   	-- 強力符文武器
			[49143] = {enable=false,},   	-- 冰霜打擊
			[51271] = {enable=false,},   	-- 冰霜之柱
			[196770] = {enable=false,},   	-- 冷酷凜冬
			[49184] = {enable=false,},   	-- 凜風衝擊
			[212552] = {enable=false,},   	-- 闇境靈行
			[207167] = {enable=false,},   	-- 致盲凍雨
			[207127] = {enable=false,},   	-- 飢狂符文武器
			[152279] = {enable=false,},   	-- 辛德拉苟莎之息
			[194913] = {enable=false,},   	-- 冰川突進
			[207256] = {enable=false,},   	-- 滅體抹殺
			[55233] = {enable=false},		-- 血族之裔
			[206930] = {enable=false},		-- 碎心打擊
			[221562] = {enable=false},		-- 窒息術
			[195292] = {enable=false},		-- 死亡的撫慰
			[195182] = {enable=false},		-- 撕骨裂髓
			[108199] = {enable=false},		-- 血魔之握
			[206977] = {enable=false},		-- 血魄之鏡
			[194844] = {enable=false},		-- 骸骨風暴
			[194679] = {enable=false},		-- 符文轉化
			[219809] = {enable=false},		-- 墓碑
			[221699] = {enable=false},		-- 血魄轉化
			[55090] = {enable=false},		-- 天譴打擊
			[47541] = {enable=false},		-- 死亡纏繞
...
--------------------------------------------------------------------------------
	EADef_Items[EA_CLASS_DRUID] = {
		...
		["ITEMS"] = {
			...
			[16886] = {enable=true,},   -- Nature's Grace / 礛ぇ界
			[48517] = {enable=true,},   -- Eclipse / ら籯
			[48518] = {enable=true,},   -- Eclipse / る籯
			[50334] = {enable=true,},   -- Berserk / ╣忌
			[52610] = {enable=true,},   -- Savage Roar / 芞〩糞
			[81192] = {enable=true,},   -- る∟
			[93400] = {enable=true,},   -- 甮琍砃
			[100977] = {enable=true,},  -- ネ
		...
		["TARITEMS"] = {			
			...
			[99] = {enable=true, self=true,},       -- в〩

			[33745] = {enable=true, self=true,},    -- Lacerate / 澄吊

			[33876] = {enable=true, self=true,},    -- Mangle(Cat) / 澄窰(聐癨篈)
			[52610] = {enable=true, self=true,},    -- 芞〩
			[81326] = {enable=true, self=false},	-- 瞶端
			[115798] = {enable=true, self=false,},	-- 畓てю阑
			[117737] = {enable=true, self=false,},	-- 碰╣ (臸4)
			[117756] = {enable=true, self=false,},	-- ┠蓝 (臸4)
		...
		["SCDITEMS"] = {
			...
			[5215] = {enable=false,},   	-- 潛行
			[6807] = {enable=false,},   	-- 槌擊
			[22812] = {enable=false,},   -- 樹皮術
			[22842] = {enable=false,},   -- 狂暴恢復
			[33917] = {enable=false,},   -- 割碎			
			[52610] = {enable=false,},   -- 兇蠻咆哮
			[61336] = {enable=false,},   -- 求生本能
			[77758] = {enable=false,},   -- 痛擊
			[78675] = {enable=false,},   -- 太陽光束
			[102280] = {enable=false,},  -- 獸性位移
			[1850] = {enable=false,},   	-- 突進
			[80313] = {enable=false,},   	-- 粉碎
			[102543] = {enable=false,},   	-- 化身:叢林之王
			[102793] = {enable=false,},   	-- 厄索之旋
			[106951] = {enable=false,},   	-- 狂暴
			[155835] = {enable=false,},   	-- 針刺毛皮
			[192081] = {enable=false,},   	-- 鋼鐵毛皮
			[192083] = {enable=false,},   	-- 厄索印記
			[194223] = {enable=false,},   	-- 星穹連線
			[202028] = {enable=false,},   	-- 兇蠻刈殺("刈"音同"意") 
			[204066] = {enable=false,},   	-- 月之光
		},
		-- GroupEvent Alert / 本職業條件技能區
		["GRPITEMS"] = {
			[1] = {
...
--------------------------------------------------------------------------------
	EADef_Items[EA_CLASS_HUNTER] = {
		...
		["ITEMS"] = {
			...
			[34471] = {enable=true,},   -- 脋み

			[35079] = {enable=true,},   -- 粇旧
			[53220] = {enable=true,},   -- Improved Stead Shot / 眏て铆㏕甮阑

			[53434] = {enable=true,},   -- ╣偿㊣酬
			[56453] = {enable=true,},   -- Lock and Load / 籛墩祇

			[82925] = {enable=true,},   -- 非称碞狐核非
			[82926] = {enable=true,},   -- 甮阑!
			[89388] = {enable=true,},   -- ю阑寄
			[94007] = {enable=true,},   -- 硈炳			
		},
		-- Alternate Alert / 本職業額外提醒區
		["ALTITEMS"] = {
			[53351] = {enable=true,},   -- Kill Shot / 阑炳甮阑
		},
		-- Target Alert / 目標提醒區
		["TARITEMS"] = {
			...
			[1978] = {enable=true, self=true,},     -- 瑀矰皏
			[1130] = {enable=true, self=true,},     -- 聐癘
			[19503] = {enable=true, self=true,},    -- 臱床甮阑
			[63468] = {enable=true, self=true,},    -- 硓甮阑
			[117737] = {enable=true, self=false,},	-- 碰╣ (臸4)
			[117756] = {enable=true, self=false,},	-- ┠蓝 (臸4)
			[123059] = {enable=true, self=false,},	-- 笆穘 (倪5糤端buff)
			[123471] = {enable=true, self=false},	-- 糤眏 (倪ぇみ2)
		...
		-- Spell Cooldown Alert / 本職業技能CD區
		["SCDITEMS"] = {			
			[17253] = {enable=false,},     -- 撕咬(基礎攻擊)
			[16827] = {enable=false,},     -- 爪擊(基礎攻擊)			
			[61684] = {enable=false,},     -- 突進(寵物)
			[54644] = {enable=false,},     -- 冰息術(奇美拉)
			[92380] = {enable=false,},     -- 霜暴之息(奇美拉)
			[160065] = {enable=false,},     -- 裂筋(異種蟲族)
			[90361] = {enable=false,},     -- 心靈治療(靈獸)
			[54680] = {enable=false,},     -- 暴猛撕咬(魔暴龍)
			[781] = {enable=false,},     	-- 逃脫
			[217200] = {enable=false,},     -- 凶暴狂亂
			[109304] = {enable=false,},     -- 心曠神怡
			[147362] = {enable=false,},     -- 駁火反擊
			[55709] = {enable=false,},     -- 鳳凰之心
			[131894] = {enable=false,},     -- 黑鴉獵殺
			[109248] = {enable=false,},     -- 禁錮射擊
			[19574] = {enable=false,},     -- 狂野怒火
			[193530] = {enable=false,},     -- 野性守護
			[186257] = {enable=false,},     -- 獵豹守護
...
--------------------------------------------------------------------------------
	EADef_Items[EA_CLASS_PALADIN] = {
		...
		-- Alternate Alert / 本職業額外提醒區
		["ALTITEMS"] = {
			[24275] = {enable=true,},   -- Hammer of Wrath / 极ぇ凌
		},
		-- Target Alert / 目標提醒區
		["TARITEMS"] = {
...
--------------------------------------------------------------------------------
	EADef_Items[EA_CLASS_PRIEST] = {
		...
		["ITEMS"] = {
			...
			[63735] = {enable=true,},   -- 诀絫確
			[77487] = {enable=true,},   -- 穞紇腳痌
			[81206] = {enable=true,},   -- 近笲锣:臔
			[81208] = {enable=true,},   -- 近笲锣:キ繰
			[81209] = {enable=true,},   -- 近笲锣:宁砫
			[87153] = {enable=true,},   -- 堵ぱㄏ
		},
		-- Alternate Alert / 本職業額外提醒區
		["ALTITEMS"] = {
		},
		...
		["SCDITEMS"] = {
			...
			[123040] = {enable=false,},   -- 屈心魔
			[205385] = {enable=false,},   -- 暗影暴擊
			[205448] = {enable=false,},   -- 虛無箭
			[228260] = {enable=false,},   -- 虛無爆發
			[8092] = {enable=false,},   	-- 心靈震爆
			[15487] = {enable=false,},   -- 沉默
			[213634] = {enable=false,},   -- 驅淨疾病
			[528] = {enable=false,},   -- 驅散魔法
			[32375] = {enable=false,},   -- 群體驅散
			[205369] = {enable=false,},   -- 心靈炸彈
			[15286] = {enable=false,},   -- 吸血鬼的擁抱
...
--------------------------------------------------------------------------------
	EADef_Items[EA_CLASS_SHAMAN] = {
		...
		["ITEMS"] = {
			...
			[16188] = {enable=true,},	-- ǔ倍
			[30884] = {enable=true,},	-- 礛臔
			[53817] = {enable=true, stack=5,},	-- 簒猌竟		
		},
		-- Alternate Alert / 本職業額外提醒區
		["ALTITEMS"] = {
		},
		...
		["TARITEMS"] = {
			...
			[8050] = {enable=true, self=true,},		-- 疨礙綺阑

			[100955] = {enable=true, self=true,},	-- 筽綹忌
			[117737] = {enable=true, self=false,},	-- 碰╣ (臸4)
			[117756] = {enable=true, self=false,},	-- ┠蓝 (臸4)
			[123059] = {enable=true, self=false,},	-- 笆穘 (倪5糤端buff)
			[123471] = {enable=true, self=false},	-- 糤眏 (倪ぇみ2)
		...
		["SCDITEMS"] = {
			...
			[2825] = {enable=false,},	-- 嗜血術
			[51490] = {enable=false,},	-- 雷霆風暴
			[51514] = {enable=false,},	-- 妖術
			[17364] = {enable=false,},	-- 風暴打擊
			[51533] = {enable=false,},	-- 野性之魂
			[51886] = {enable=false,},	-- 淨化靈魂
			[57994] = {enable=false,},	-- 削風術
			[58875] = {enable=false,},	-- 幽魂步伐
			[60103] = {enable=false,},	-- 熔岩爆擊
			[187874] = {enable=false,},	-- 閃電轟擊
			[193786] = {enable=false,},	-- 石化打擊
			[193796] = {enable=false,},	-- 火舌打擊
			[196834] = {enable=false,},	-- 冰封打擊
			[215864] = {enable=false,},	-- 時雨
...
--------------------------------------------------------------------------------
	EADef_Items[EA_CLASS_WARRIOR] = {
		...
		["ITEMS"] = {
			...
			[1134] = {enable=true,},    -- み艶ぇ
			[2565] = {enable=true,},    -- 礟郎(ň縨篈)
			[12328] = {enable=true,},   -- 绢苯ю阑(驹矮╣忌篈)
			[12964] = {enable=true,},   -- 驹矮℉
			[12975] = {enable=true,},   -- 瘆℉︵
			[14202] = {enable=true,},   -- ╣(单 3)
			[16491] = {enable=true,},   -- ﹀ぇ╣荐
			[20230] = {enable=true,},   -- は阑忌(驹矮篈)
			[23885] = {enable=true,},   -- 遁﹀
			[29841] = {enable=true,},   -- 確礵ぇ(单1)
			[32216] = {enable=true,},   -- 秤
			[46916] = {enable=true,},   -- Bloodsurge (Slam) / 荐﹀猰乃
			[50227] = {enable=true,},   -- 糃纠
			[52437] = {enable=true,},   -- 艼
			[55694] = {enable=true,},   -- ╣確
			[57516] = {enable=true,},   -- ╣(单 2)
			[57519] = {enable=true,},   -- ╣(单 2)
			[60503] = {enable=true,},   -- ﹀竰砰喷
			[65156] = {enable=true,},   -- 墩ぃ讽
			[82368] = {enable=true,},   -- 秤
			[84586] = {enable=true,},   -- 監甠(单 3)
			[84620] = {enable=true,},   -- 绊皚絬
			[85730] = {enable=true,},   -- ↖帝炳诀
			[86627] = {enable=true,},   -- 縀笆
			[87096] = {enable=true,},   -- 筽阑
			[90806] = {enable=true,},   -- 矪∕			
		},
		-- Alternate Alert / 本職業額外提醒區
		["ALTITEMS"] = {
		...
		["TARITEMS"] = {
			...
			[81326] = {enable=true, self=false},	-- 瞶端
			[94009] = {enable=true, self=true,},    -- 脊吊
			[115798] = {enable=true, self=false,},	-- 畓てю阑
			[117737] = {enable=true, self=false,},	-- 碰╣ (臸4)
			[117756] = {enable=true, self=false,},	-- ┠蓝 (臸4)
			[123059] = {enable=true, self=false,},	-- 笆穘 (倪5糤端buff)
		...
		-- Spell Cooldown Alert / 本職業技能CD區
		["SCDITEMS"] = {
			[1719] = {enable=false},    		--戰鬥狂嘯
			[12292] = {enable=false},    	--浴血
			[18499] = {enable=false},    	--狂暴之怒
			[107574] = {enable=false},    	--巨像化身
			[184367] = {enable=false},    	--暴怒	
			[46924] = {enable=false},    	--劍刃風暴
			[100] = {enable=false},    		--衝鋒
			[6544] = {enable=false},    		--英勇躍擊
			[6552] = {enable=false},    		--拳擊
			[85288] = {enable=false},    	--狂怒之擊
			[23881] = {enable=false},    	--嗜血
			[5308] = {enable=false},    		--斬殺
			[163201] = {enable=false},    	--斬殺(武戰)
			[107570] = {enable=false},    	--暴風怒擲
			[46968] = {enable=false},    	--震攝波
			[118038] = {enable=false},		--劍下亡魂
			[34428] = {enable=false},		--勝利衝擊
			[12294] = {enable=false},		--致死打擊
			[845] = {enable=false},			--順劈斬
			[167105] = {enable=false},		--千鈞潰擊
			[207982] = {enable=false},		--集中怒氣
			[152277] = {enable=false},		--劫毀旋刃(武戰)(招架+30%/12s)
			[228920] = {enable=false},		--劫毀旋刃(防戰)(招架+30%/12s)
			[198304] = {enable=false},		--攔截
			[202168] = {enable=false},		--勝利在望
			[23920] = {enable=false},		--法術反射
			[1160] = {enable=false},			--挫志怒吼
			[871] = {enable=false},			--盾牆
			[6572] = {enable=false},			--復仇
			[2565] = {enable=false},			--盾牌格檔
			[23922] = {enable=false},		--盾牌猛擊
			[6343] = {enable=false},			--雷霆一擊
			[207982] = {enable=false},		--集中怒氣(武戰致死打擊增傷)
			[204488] = {enable=false},		--集中怒氣(防戰盾牌猛擊增傷)
			[12975] = {enable=false},		--破釜沉舟
...
--------------------------------------------------------------------------------
	EADef_Items[EA_CLASS_MONK] = {
		...
		["ITEMS"] = {
			...
			[118674] = {enable=true,},   -- 弘癵铭


			[125359] = {enable=true,},   -- 
			[132120] = {enable=true,},   -- 癵铭路露			
		},
		-- Alternate Alert / 本職業額外提醒區
		["ALTITEMS"] = {
		},
		...
		["TARITEMS"] = {			
			...
			[81326] = {enable=true, self=false},	-- 瞶端
			[132120] = {enable=true, self=true,},   -- 癵铭路露
			[115798] = {enable=true, self=false,},	-- 畓てю阑
			[117737] = {enable=true, self=false,},	-- 碰╣ (臸4)
			[117756] = {enable=true, self=false,},	-- ┠蓝 (臸4)
			[123059] = {enable=true, self=false,},	-- 笆穘 (倪5糤端buff)
