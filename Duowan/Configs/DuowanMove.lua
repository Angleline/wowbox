...
if (dwIsConfigurableAddOn("DejaCharacterStats") or dwIsConfigurableAddOn("DejaCharacterStats")) then
	dwRegisterButton(
		"DuowanMoveMod",
		DUOWANMOVE_DEJA, 
		function()			
			if (dwIsAddOnLoaded("DejaCharacterStats")) then
				HideUIPanel(DuowanConfigFrame);
