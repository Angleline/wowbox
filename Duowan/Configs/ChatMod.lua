...
if (GetLocale() == "zhCN") then
	...
	DUOWAN_CHAT_MOD_BIG_FORWARDER = "开启世界频道";
	DUOWAN_CHAT_MOD_BIG_FORWARDER_DESC = "开启后会自动加入世界频道";
	DUOWAN_CHAT_MOD_ChatLinkLevel = "聊天框物品等级显示"
	DUOWAN_CHAT_MOD_ChatLinkLevel_DESC = "开启聊天框物品等级显示"
elseif (GetLocale() == "zhTW") then
	...
	DUOWAN_CHAT_MOD_BIG_FORWARDER = "開啟世界頻道";
	DUOWAN_CHAT_MOD_BIG_FORWARDER_DESC = "開啟後會自動加入世界頻道";
	DUOWAN_CHAT_MOD_ChatLinkLevel = "聊天框物品等级显示"
	DUOWAN_CHAT_MOD_ChatLinkLevel_DESC = "开启聊天框物品等级显示"
else
	DUOWAN_CHAT_MOD_TITLE = "聊天增强";
...
if (dwIsConfigurableAddOn("DuowanChat")) then
	...
	dwRegisterCheckButton(
		"ChatMod",
		DUOWAN_CHAT_MOD_BIG_FORWARDER,
		DUOWAN_CHAT_MOD_BIG_FORWARDER_DESC,
		"BIGForwarder",
		1,
		function (arg)		
			if (arg == 1) then				
	...
	dwRegisterCheckButton(
		"ChatMod",
		DUOWAN_CHAT_MOD_ChatLinkLevel,
		DUOWAN_CHAT_MOD_ChatLinkLevel_DESC,
		"ChatLinkLevel",
		1,
		function (arg)		
