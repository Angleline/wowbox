...
WorldMapDetailFrame = WorldFrame
...
if GetLocale() == "zhCN" then
	SetTranslations( "术士", "WARLOCK", "战士", "WARRIOR", "猎人", "HUNTER", "法师", "MAGE", "牧师", "PRIEST", "德鲁伊", "DRUID", "圣骑士", "PALADIN", "萨满祭司", "SHAMAN", "潜行者", "ROGUE", "死亡骑士", "DEATHKNIGHT", "术士", "WARLOCK", "战士", "WARRIOR", "猎人", "HUNTER", "法师", "MAGE", "牧师", "PRIEST", "德鲁伊", "DRUID", "圣骑士", "PALADIN", "萨满祭司", "SHAMAN", "潜行者", "ROGUE", "死亡骑士", "DEATHKNIGHT", "恶魔猎手", "DEMONHUNTER" )
elseif GetLocale()  == "zhTW" then
	SetTranslations( "術士", "WARLOCK", "戰士", "WARRIOR", "獵人", "HUNTER", "法師", "MAGE", "牧師", "PRIEST", "德魯伊", "DRUID", "聖騎士", "PALADIN", "薩滿", "SHAMAN", "盜賊", "ROGUE", "死亡騎士", "DEATHKNIGHT", "術士", "WARLOCK", "戰士", "WARRIOR", "獵人", "HUNTER", "法師", "MAGE", "牧師", "PRIEST", "德魯伊", "DRUID", "聖騎士", "PALADIN", "薩滿", "SHAMAN", "盜賊", "ROGUE", "死亡騎士", "DEATHKNIGHT", "惡魔獵手", "DEMONHUNTER" )
end
...
function dwUpdatePaladinPowerFrame()
	...
	dwSetScale(PaladinPowerBarFrame, scale);
	if (value == 2) then
		PaladinPowerBarFrame:ClearAllPoints();
		if (EUF_PlayerFrameXPBar and EUF_PlayerFrameXPBar:IsVisible()) then			
			PaladinPowerBarFrame:SetPoint("TOP", "PlayerFrame", "BOTTOM", 85, 22);
		else
			PaladinPowerBarFrame:SetPoint("TOP", "PlayerFrame", "BOTTOM", 43, 39);
		end
		PaladinPowerBarFrameBG:SetTexture("Interface\\PlayerFrame\\PaladinPowerTextures");
		PaladinPowerBarFrameBG:SetTexCoord(0.00390625, 0.53515625, 0.32812500, 0.63281250);
		PaladinPowerBarFrameGlowBGTexture:SetTexture("Interface\\PlayerFrame\\PaladinPowerTextures");
		PaladinPowerBarFrameGlowBGTexture:SetTexCoord(0.00390625, 0.53515625, 0.00781250, 0.31250000);
	else
		local pos = dwRawGetCVar("DuowanConfig", "PaladinFramePos", nil);
		if (pos and type(pos) == "table" and not PaladinPowerBarFrame.isMoving) then
			PaladinPowerBarFrame:ClearAllPoints();
			PaladinPowerBarFrame:SetPoint(unpack(pos));

			PaladinPowerBarFrameBG:SetTexture("Interface\\AddOns\\Duowan\\textures\\PaladinPowerNormal");
			PaladinPowerBarFrameBG:SetTexCoord(0.00390625, 0.53515625, 0.32812500, 0.63281250);
			PaladinPowerBarFrameGlowBGTexture:SetTexture("Interface\\AddOns\\Duowan\\textures\\PaladinPowerGlow");
...
function dwUpdateEclipseBarFrame()
	...
	if not EclipseBarFrame then return; end
...
local ChallengesKeystoneFr = CreateFrame('Frame');
ChallengesKeystoneFr:SetScript("OnEvent", function(self, event, ...)
	self[event](self, ...)
end)
ChallengesKeystoneFr:RegisterEvent('CHALLENGE_MODE_KEYSTONE_RECEPTABLE_OPEN')

function ChallengesKeystoneFr:CHALLENGE_MODE_KEYSTONE_RECEPTABLE_OPEN()
